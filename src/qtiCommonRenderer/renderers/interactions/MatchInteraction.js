...
import __ from 'i18n';
import tpl from 'taoQtiItem/qtiCommonRenderer/tpl/interactions/matchInteraction';
...
var _inferValue = function(element) {
    ...
    var firstId = $('.matrix > thead th', $container)
        .eq(x)
        .data('identifier');
    var secondId = $('.matrix > tbody th', $container)
        .eq(y)
        .data('identifier');
