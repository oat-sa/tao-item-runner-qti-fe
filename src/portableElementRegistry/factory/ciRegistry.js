...
import portableElementRegistry from 'taoQtiItem/portableElementRegistry/factory/factory';
import qtiElements from 'taoQtiItem/qtiCreator/helper/qtiElements';
 ...
 */
export default function customInteractionRegistry() {
    return portableElementRegistry({
        getAuthoringData: function getAuthoringData(typeIdentifier, options) {
            ...
            if (
                ...
                (pciModel.enabled || !options.enabledOnly)
            ) {
                return {
