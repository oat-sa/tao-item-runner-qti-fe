 ...
 */
import gapMatchInteraction from 'taoQtiItem/qtiCommonRenderer/renderers/interactions/GapMatchInteraction';

/**
 * Expose the common renderer for the gapmatch interaction
 * @exports reviewRenderer/renderers/interactions/GapMatchInteraction
 */
export default Object.assign({}, gapMatchInteraction, {render: () => null});