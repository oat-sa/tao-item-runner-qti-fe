    ...
    QUnit.test('renders an item', function(assert) {
        ...
        new QtiLoader().loadItemData(itemData, function(item) {
            renderer.load(function() {
                ...
                assert.equal(
                    $('.qti-include', $result).data('href'),
                    'taomedia://mediamanager/http_2_tao12_0_local_1_first_0_rdf_3_i1550672688604730',
                    'The qti include has the expected href attribute'
                );
