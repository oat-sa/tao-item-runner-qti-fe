...
define([
    ...
    var cases = [
        ...
        {
            title: 'single choice correct - no correct response',
            data: dataChoiceCorrectNoResponse,
            expectedMaximum: 0,
            maxScore: 0
        },
        ...
        {
            title: 'single choice correct - impossible min choice',
            data: dataChoiceCorrectMultiple,
            expectedMaximum: 1,
            maxScore: 1,
        ...
        {
            title: 'single choice map - map default > 3',
            data: dataChoiceMaxchoice3,
            expectedMaximum: 3,
            maxScore: 3,
            changeData: function(data) {
        ...
        {
            title: 'single choice map - map default > 3 and 2 map entries',
            data: dataChoiceMaxchoice3,
            expectedMaximum: 5,
            maxScore: 5,
            changeData: function(data) {
        ...
        {
            title: 'single choice map - no map entries',
            data: dataChoiceMaxchoice3,
            expectedMaximum: 0,
            maxScore: 0,
            changeData: function(data) {
        ...
        {
            title: 'composite choice correct and map',
            data: dataCompositeChoiceCorrectMap,
            expectedMaximum: 2.5,
            maxScore: 2.5
        },
        {
            title: 'inline choice correct - no correct response',
        ...
        {
            title: 'text entry - correct but impossible pattern mask',
            data: dataTextentryCorrectImpossiblePatternMask,
            expectedMaximum: 0,
            maxScore: 0
        },
        {
            title: 'text entry - map but some impossible pattern mask',
            data: dataTextentryMapImpossiblePatternMask,
            expectedMaximum: 0.5,
            maxScore: 0.5
        },
        { title: 'extended text', data: dataExtendedText, expectedMaximum: 1, maxScore: 1 },
        {
            title: 'extended text - manual scoring',
            data: dataExtendedTextManualScoring,
            expectedMaximum: 0,
            maxScore: 3
        },
        {
            title: 'extended text - manual scoring with correct',
            data: dataExtendedTextManualScoringWithCorrect,
            expectedMaximum: 1,
            maxScore: 4
        },
        ...
        {
            title: 'gap match - correct matchMax',
            data: dataGapmatchCorrect,
            expectedMaximum: 0,
            maxScore: 0,
            changeData: function(data) {
                data.responses.responsedeclaration_58f5e075ede73619627566.correctResponses = [
                    'choice_11 gap_2',
                    'choice_11 gap_1'
                ];
                return data;
        ...
        {
            title: 'gap match - map (no match max)',
            data: dataGapmatchMap,
            expectedMaximum: 3.5,
            maxScore: 3.5,
            changeData: function(data) {
        ...
        {
            title: 'associate - correct impossible',
            data: dataAssociateCorrect,
            expectedMaximum: 0,
            maxScore: 0,
            changeData: function(data) {
        ...
        {
            title: 'associate - map - matchMax=1',
            data: dataAssociateMap,
            expectedMaximum: 2,
            maxScore: 2,
            changeData: function(data) {
        ...
        {
            title: 'associate - map - maxAssociations=1',
            data: dataAssociateMap,
            expectedMaximum: 2,
            maxScore: 2,
            changeData: function(data) {
        ...
        {
            title: 'associate - map - minAssociations=3',
            data: dataAssociateMap,
            expectedMaximum: 3,
            maxScore: 3,
            changeData: function(data) {
        ...
        {
            title: 'associate - map - minAssociations=5',
            data: dataAssociateMap,
            expectedMaximum: 3,
            maxScore: 3,
            changeData: function(data) {
        ...
        {
            title: 'associate - map - map default > 0',
            data: dataAssociateMap,
            expectedMaximum: 5,
            maxScore: 5,
            changeData: function(data) {
        ...
        {
            title: 'associate - match max - favorable mapping',
            data: dataAssociateMatchmax,
            expectedMaximum: 15,
            maxScore: 15
        },
        {
            title: 'associate - match max - favorable mapping disrupt',
            data: dataAssociateMatchmax,
            expectedMaximum: 14,
            maxScore: 14,
            changeData: function(data) {
        ...
        {
            title: 'associate - match max - unfavorable mapping',
            data: dataAssociateMatchmax,
            expectedMaximum: 11,
            maxScore: 11,
            changeData: function(data) {
        ...
        {
            title: 'gap match - match max = 0 - favorable mapping',
            data: dataGapMatchMatchmax,
            expectedMaximum: 4,
            maxScore: 4
        },
        {
            title: 'gap match - match max = 1 - neutral mapping',
            data: dataGapMatchMapMatchmax,
            expectedMaximum: 6,
            maxScore: 6
        },
        {
            title: 'gap match - inifinite score',
            data: dataGapMatchInfinite,
            expectedMaximum: undefined,
            maxScore: undefined
        },
        {
            title: 'gap association - match max - favorable mapping',
